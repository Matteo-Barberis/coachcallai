      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-16">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://discord.gg/7g52pYK2yg" className={`w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 ${theme.hover} ${theme.primary} transition-colors`}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#features" className={`text-gray-600 ${theme.hoverPrimary}`}>WhatsApp Integration</a></li>
              <li><a href="#features" className={`text-gray-600 ${theme.hoverPrimary}`}>Phone Calls</a></li>
              <li><a href="#features" className={`text-gray-600 ${theme.hoverPrimary}`}>Progress Tracking</a></li>
              <li><a href="#features" className={`text-gray-600 ${theme.hoverPrimary}`}>Goal Setting</a></li>
              <li><a href="#features" className={`text-gray-600 ${theme.hoverPrimary}`}>AI Technology</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className={`text-gray-600 ${theme.hoverPrimary}`}>Blog</a></li>
              <li><Link to="/support" className={`text-gray-600 ${theme.hoverPrimary}`}>Support</Link></li>
              <li><a href="#faq" className={`text-gray-600 ${theme.hoverPrimary}`}>FAQ</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className={`text-gray-600 ${theme.hoverPrimary}`}>About Us</a></li>
              <li><Link to="/privacy-policy" className={`text-gray-600 ${theme.hoverPrimary}`}>Privacy Policy</Link></li>
              <li><Link to="/terms-of-service" className={`text-gray-600 ${theme.hoverPrimary}`}>Terms of Service</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <Link to="/privacy-policy" className={`text-gray-500 text-sm ${theme.hoverPrimary}`}>Privacy Policy</Link>
            <Link to="/terms-of-service" className={`text-gray-500 text-sm ${theme.hoverPrimary}`}>Terms of Service</Link>
            <a href="#" className={`text-gray-500 text-sm ${theme.hoverPrimary}`}>Cookies</a>
          </div>
        </div>
      </div>
    </footer>;
