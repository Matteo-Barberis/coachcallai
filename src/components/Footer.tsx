      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-16">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://discord.gg/7g52pYK2yg" className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 hover:bg-black hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <Link to="/privacy-policy" className="text-gray-500 text-sm hover:text-black">Privacy Policy</Link>
            <Link to="/terms-of-service" className="text-gray-500 text-sm hover:text-black">Terms of Service</Link>
            <a href="#" className="text-gray-500 text-sm hover:text-black">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
