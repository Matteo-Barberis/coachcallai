        ...
        <div className="flex flex-col space-y-8 animate-fade-in">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className={`text-base md:text-lg py-6 px-8 ${theme.gradient} hover:opacity-90`} onClick={handleGetStarted}>
                Start Your Journey
              </Button>
              <Button variant="outline" className={`text-base md:text-lg py-6 px-8 ${theme.border} ${theme.primary} ${theme.hover}`}>
                Watch Demo
              </Button>
            </div>
          </div>
