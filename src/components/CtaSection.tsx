    ...
    <section id="contact" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          <div className={`${theme.gradient} p-10 md:p-16 text-white text-center`}>
            ...
            <div className="flex justify-center">
              <Button 
                ...
                className={`bg-white ${theme.primary} hover:bg-white/90 font-semibold py-6 px-8`}
              >
          ...
          <div className="bg-white p-10 md:p-16 grid md:grid-cols-3 gap-10">
            <div className="text-center">
              <div className={`w-16 h-16 mx-auto rounded-full ${theme.light} flex items-center justify-center mb-4`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={theme.primary}>
              ...
              <p className="text-gray-600">Our support team is available to help you with any questions or issues.</p>
            </div>
