      ...
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="bg-white p-6 md:p-16">
            {isMobile ? (
              // Mobile layout - icons in a row with just titles
              <div className="flex justify-around">
                <div className="text-center">
                  <div className="w-14 h-14 mx-auto rounded-full bg-brand-light flex items-center justify-center mb-2">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm font-semibold">Proven Results</h3>
                </div>
