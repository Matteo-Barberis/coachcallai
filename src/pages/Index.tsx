  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <div className={`fixed top-12 md:top-16 right-4 z-50 badge-container hidden ${showBadge ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform -translate-y-4'}`}>
